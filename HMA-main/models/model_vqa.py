...
class MUMC_VQA(nn.Module):
    def __init__(self,
        ...
        if init_vit:
            checkpoint = torch.load(config['vision_path'], map_location="cpu")
        ...
        if self.distill:
            ...
            if init_vit:
                ...
                pos_embed_reshaped = interpolate_pos_embed(state_dict['pos_embed'], self.visual_encoder_m)
                state_dict['pos_embed'] = pos_embed_reshaped
                self.visual_encoder_m.load_state_dict(state_dict)
